...
public class AMQPConfiguration {
    ...
    @Bean
    public TopicExchange challengesTopicExchange(@Value("${ampq.exchange.attempts}") final String exchangeName) {
    ...
    @Bean
    public Binding correctAttemptBinding(final Queue gamificationQueue, final TopicExchange attemptExchange) {
        return BindingBuilder.bind(gamificationQueue).to(attemptExchange).with("attempt.correct");
    }
